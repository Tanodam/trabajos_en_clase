...
A. Realizar un solo listado de las pantallas ordenadas por los siguientes criterios:
   ...
   o Nombre (ascendentemente) -hecho
...
int main()
{
    ...
    pantalla_altaForzada(array,QTY,"Wilde","Las Flores 50",2000,0);
    pantalla_altaForzada(array,QTY,"Avellaneda","Belgrano 250",2000,0);
    pantalla_altaForzada(array,QTY,"Bernal","Cerrito 300",3000,0);
    pantalla_altaForzada(array,QTY,"Quilmes","Lavalle 450",9,1);
    pantalla_altaForzada(array,QTY,"Berazategui","Mitre 150",10,1);

    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,0,"video.avi","20911911915",10);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,0,"video1.avi","20911911915",9);
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,0,"video2.avi","30911911915",10);
    ...
    //informar_ordenarPrecioYNombre(array,QTY,1);
    //informar_valorPantalla(array,QTY);
    //informar_promediosValores(array,QTY);
    informar_contratacionesDiasIgualMenorDiez(array,contrataciones,QTY,LEN_CONT);
